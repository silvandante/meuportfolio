...
export const MobileNavLinksContainer = tw.nav`flex flex-1 items-center justify-between right-0`;
export const NavToggle = tw.button`
  lg:hidden z-20 fixed focus:outline-none hocus:text-blue-500 transition duration-300 right-0
`;
...
export default ({ roundedHeaderButton = false, logoLink, links, className, collapseBreakpointClass = "lg" }) => {
  ...
  const defaultLogoLink = (
    <LogoLink href="/">
      <img src={'https://silvandante.github.io/meuportfolio/logo192.png'} alt="logo" />
      Anny W
    </LogoLink>
  );
