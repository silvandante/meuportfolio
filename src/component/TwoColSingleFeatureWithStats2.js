...
export default ({
  ...
  heading = (
    <>
      A garota desenvolvedor<span tw="text-blue-500">a.</span>
    </>
  ),
  description = "Entrei no mundo da tecnologia pelo sonho de infância de desenvolver jogos, mas no meio do caminho do curso de Computação me deparei com o universo Mobile e Web, fiquei fascinada com as tecnologias e possibilidades do desenvovilmento móvel e online, então passei a focar toda minha energia em me tornar especialista nisso.",
    ...
    <Container id="aboutme">
      <TwoColumn css={!imageInsideDiv && tw`md:items-center`}>
        <ImageColumn css={imageContainerCss}>
          {imageInsideDiv ? <Image imageSrc={'../images/estudante.jpg'} css={imageCss} /> : <img src={imageSrc} css={imageCss} alt="" />}
