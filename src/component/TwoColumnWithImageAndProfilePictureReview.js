...
export default ({
  subheading = "",
  heading = "Portfólio",
  description = "Algum dos trabalhos que realizei ao longo do tempo",
  testimonials = null,
  textOnLeft = false
}) => {
  /*
  ...
  const defaultTestimonials = [
  
    {
      ...
      quote:
        "UFRRGo: uso de Realidade Aumentada para navegação com gamificação pelo campus da UFRR (RA com e sem marcador)",
      customerName: "Anny Walker",
      customerTitle: "Responsável por Dev Mobile Integração Google Services",
      url: "https://drive.google.com/file/d/1btFriBT4wbJelMTkVeg-eGpbPvwtcHcC/view?usp=sharing"
    },
    {
      imageSrc:
      ...
      profileImageSrc:
        "https://avatars3.githubusercontent.com/u/26912688?s=400&u=651cd85c269b9268e8a9fe03ed8c965b2989a333&v=4",
      quote:
        "Projeto com mapas online e offline com sincronização e notificação em tempo real.",
      customerName: "Anny Walker",
      customerTitle: "Responsável por Front-End, Back-End e integração com Google Maps, FCM e Arquitetura Offline Frist",
      url: "https://github.com/silvandante"
    },
    {
      imageSrc:
    ...
    },
    {
      ...
      profileImageSrc:
        "https://avatars3.githubusercontent.com/u/26912688?s=400&u=651cd85c269b9268e8a9fe03ed8c965b2989a333&v=4",
      quote:
        "VIDA APP: app para doações e arrecadações para comunidades originárias do Brasil.",
      customerName: "Anny Walker",
      customerTitle: "Responsável por Dev Mobile",
      url: "https://play.google.com/store/apps/details?id=com.vida_app"
    },
    {
      imageSrc:
      ...
      profileImageSrc:
        "https://avatars3.githubusercontent.com/u/26912688?s=400&u=651cd85c269b9268e8a9fe03ed8c965b2989a333&v=4",
      quote:
        "Escola Masterbots: landing page dinâmica com informações da escola e contato.",
      customerName: "Anny Walker",
      customerTitle: "Responsável por Front-End e Back-End",
      url: "https://escolamasterbots.herokuapp.com/"
    },
    {
      imageSrc:
      ...
      profileImageSrc:
        "https://avatars3.githubusercontent.com/u/26912688?s=400&u=651cd85c269b9268e8a9fe03ed8c965b2989a333&v=4",
      quote:
        "Frente Cultural: projeto para organização e visualização dos pontos culturais do Brasil.",
      customerName: "Anny Walker",
      customerTitle: "Responsável por Front-End, Back-End e integração com Google Maps",
      url: "https://pontosculturais.conafer.org.br/"
    }
  ];
              ...
              <TestimonialImageSlider arrows={false} ref={setImageSliderRef} asNavFor={textSliderRef} fade={true}>
                {testimonials.map((testimonial, index) => (
                  <ImageAndControlContainer key={index}>
                    <Image style={{cursor:"pointer"}} onClick={() => window.open(testimonial.url)} imageSrc={testimonial.imageSrc} />
                    <ControlContainer>
